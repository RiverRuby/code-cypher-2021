# from https://github.com/cristobalvch/Music-Lyrics-NLP/blob/master/helpers.py
...
def search_data(query,songname_list,n,access_token):
    """
    ...
    artist = api.search_artist(query,max_songs=3)
